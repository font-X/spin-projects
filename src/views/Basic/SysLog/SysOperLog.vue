<template>
  <el-container>
    <el-card class="cardMargin" id="mainCard">
      ...
      <el-row>
        <jy-page-table
          :columns="columns"
          ref="grid"
          :action="'/SysLog/GetOperLogPageList'"
          :multiple="false"
          :height="gridHeight"
          :querModel="model"
        ></jy-page-table>
    ...
    <sys-oper-log-info ref="exinfo" :Id="selectId"></sys-oper-log-info>
  </el-container>
  <!-- 查询框 -->
</template>
<script>
import JyPageTable from '@/components/JyPageTable'
import SysOperLogInfo from './SysOperLogInfo.vue'
export default {
  components: { JyPageTable, SysOperLogInfo },
  data() {
    return {
      gridHeight: 600,
      loading: false,
      ...
      columns: [
        ...
        { width: '80', title: '时间', field: 'Time', sortable: true },
        { width: '80', title: '类别', field: 'Type' },
        { width: '280', title: 'api描述', field: 'ApiMemo' },
