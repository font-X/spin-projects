<template>
  <div>
    <div style="width: 100%; padding-left: 30px">
      <div class="orderprogressbutton" @click="proressClick('', $event)">
        全部
      </div>
      <div class="orderprogressend"></div>
      <div :key="index" v-for="(item, index) in progressItem1">
        <div class="orderprogressfirst"></div>
        <div
          class="orderprogressbutton"
          @click="proressClick(item.Schedule, $event)"
        >
          {{ item.chnName }}
        </div>
        <div class="orderprogressend"></div>
    ...
    <div class="orderprogressbutton" style="width:40px;background-color: white;margin-right:8px;z-index:9">
    </div>
    <div :key="index" v-for="(item, index) in progressItem2">
      <div class="orderprogressfirst"></div>
      <div
        class="orderprogressbutton"
        @click="proressClick(item.Schedule, $event)"
...
export default {
  ...
  methods: {
    ...
    proressClick(val, event) {
      if (this.curProgrese != null) this.curProgrese.style['color'] = ''
      this.curProgrese = event.currentTarget
      this.curProgrese.style['color'] = 'red'
...
.orderprogressend {
  ...
  border-top-width: 12px;
  border-style: solid;
  border-color: transparent transparent transparent rgb(162, 185, 115);
  z-index: 3;
}
.orderprogressbutton {
  position: relative;
